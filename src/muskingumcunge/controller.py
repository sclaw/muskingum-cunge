...
def create_project(path):
    template = {
        ...
        "geometry_dir": "",  # expecting the format of the geometry folder generated by https://github.com/CIROH-UVM/floodplain-routing
        "geometry_source": "NWM",
        "optimize_dx": False,
        "conserve_mass": False,
        "short_ts": False,
...
def execute(meta_path):
    ...
    # Run model
    network.run_event(optimize_dx=paths['optimize_dx'], conserve_mass=paths['conserve_mass'], lat_addition=paths['lat_addition'], short_ts=paths['short_ts'])
    os.makedirs(paths['out_dir'], exist_ok=True)
